...
typedef short OPLSAMPLE;
#endif
#if (OPL_SAMPLE_BITS==8)
typedef char OPLSAMPLE;
#endif
...
void YM3812UpdateOne(int which, short * buffer, int length);
...
*/
void YM3526UpdateOne(int which, short * buffer, int length);
...
void Y8950UpdateOne(int which, short * buffer, int length);
