...
#define joined_byAll(l, f, t)                       \
    {                                               \
        SetObjectListAttr(f, t);                    \
        AskAll(dbGetObject(l), 8, BuildObjectList); \
    }
...
#define hurtAll(l, f, t)                             \
    {                                                \
        SetObjectListAttr(f, t);                     \
        AskAll(dbGetObject(l), 12, BuildObjectList); \
    }
...
#define rememberAll(l, f, t)                         \
    {                                                \
        SetObjectListAttr(f, t);                     \
        AskAll(dbGetObject(l), 18, BuildObjectList); \
    }
...
#define hasAll(l, f, t)                             \
    {                                               \
        SetObjectListAttr(f, t);                    \
        AskAll(dbGetObject(l), 4, BuildObjectList); \
    }
...
#define taxiAll(l, f, t)                             \
    {                                                \
        SetObjectListAttr(f, t);                     \
        AskAll(dbGetObject(l), 16, BuildObjectList); \
    }
...
#define learnedAll(l, f, t)                          \
    {                                                \
        SetObjectListAttr(f, t);                     \
        AskAll(dbGetObject(l), 17, BuildObjectList); \
    }
...
#define soundAll(l, f, t)                            \
    {                                                \
        SetObjectListAttr(f, t);                     \
        AskAll(dbGetObject(l), 13, BuildObjectList); \
    }
...
#define ClockTimerAll(l, f, t)                      \
    {                                               \
        SetObjectListAttr(f, t);                    \
        AskAll(dbGetObject(l), 2, BuildObjectList); \
    }
...
#define PersonWorksHereAll(l, f, t)                  \
    {                                                \
        SetObjectListAttr(f, t);                     \
        AskAll(dbGetObject(l), 20, BuildObjectList); \
    }
...
#define hasClockAll(l, f, t)                        \
    {                                               \
        SetObjectListAttr(f, t);                    \
        AskAll(dbGetObject(l), 1, BuildObjectList); \
    }
...
#define toolRequiresAll(l, f, t)                     \
    {                                                \
        SetObjectListAttr(f, t);                     \
        AskAll(dbGetObject(l), 15, BuildObjectList); \
    }
...
#define knowsAll(l, f, t)                           \
    {                                               \
        SetObjectListAttr(f, t);                    \
        AskAll(dbGetObject(l), 5, BuildObjectList); \
    }
...
#define hasLootBagAll(l, f, t)                       \
    {                                                \
        SetObjectListAttr(f, t);                     \
        AskAll(dbGetObject(l), 19, BuildObjectList); \
    }
...
#define likes_to_beAll(l, f, t)                     \
    {                                               \
        SetObjectListAttr(f, t);                    \
        AskAll(dbGetObject(l), 6, BuildObjectList); \
    }
...
#define joinAll(l, f, t)                            \
    {                                               \
        SetObjectListAttr(f, t);                    \
        AskAll(dbGetObject(l), 7, BuildObjectList); \
    }
...
#define opensAll(l, f, t)                            \
    {                                                \
        SetObjectListAttr(f, t);                     \
        AskAll(dbGetObject(l), 14, BuildObjectList); \
    }
...
#define livesInAll(l, f, t)                          \
    {                                                \
        SetObjectListAttr(f, t);                     \
        AskAll(dbGetObject(l), 10, BuildObjectList); \
    }
...
#define breakAll(l, f, t)                            \
    {                                                \
        SetObjectListAttr(f, t);                     \
        AskAll(dbGetObject(l), 11, BuildObjectList); \
    }
...
#define StairConnectsAll(l, f, t)                   \
    {                                               \
        SetObjectListAttr(f, t);                    \
        AskAll(dbGetObject(l), 3, BuildObjectList); \
    }
...
#define usesAll(l, f, t)                            \
    {                                               \
        SetObjectListAttr(f, t);                    \
        AskAll(dbGetObject(l), 9, BuildObjectList); \
    }
...
#define isGuardedbyAll(l, f, t)                          \
    {                                                    \
        SetObjectListAttr(f, t);                         \
        AskAll(dbGetObject(l), 500003, BuildObjectList); \
    }
...
#define startsWithAll(l, f, t)                           \
    {                                                    \
        SetObjectListAttr(f, t);                         \
        AskAll(dbGetObject(l), 500001, BuildObjectList); \
    }
...
#define consistsOfAll(l, f, t)                           \
    {                                                    \
        SetObjectListAttr(f, t);                         \
        AskAll(dbGetObject(l), 500002, BuildObjectList); \
    }
