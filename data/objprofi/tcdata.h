...
enum LootNameE {Kein_Name, Eine_Zigarrenkiste, Ein_Tiefgekuehlter_Hummer, Eine_Cartier_Uhr, Ein_Sanskrit_Buch, Ein_Autogramm_von_Oscar_Wilde,
 Ein_Beauty_Case, Ein_Sparstrumpf, Eine_Toilettetasche, Die_Gebeine_von_Karl_Marx, Eine_Bibel, Eine_Bronzestatue, Ein_Silbergeschirr, Eine_Buddhastatue,
 Eine_Chinavase, Der_Stein_von_Rosetta, Die_Magna_Charta, Eine_Muenzsammlung, Ein_Goldring, Ein_Saurierknochen, Eine_Insektensammlung, Ein_Bernstein,
 Das_Jadepferd, Eine_Victorianische_Vase, Die_Kronjuwelen, Der_Ring_des_Abtes, Ein_Koffer, Ein_Dokument, Sherlock_Holmes_Opiumpfeife,
 Eine_Hottentotten_Figur, Eine_Batman_Figur, Ein_Dicker_Man, Ein_Unbekannter, Eine_Jack_the_Ripper_Figur, Eine_Koenigs_Figur, Eine_Wache_Figur,
 Eine_Miss_World_1952_Figur, Eine_Formel, Die_Unterhose_der_Queen, Der_Stone_of_Cone};
enum SexE {Maennlich, Weiblich};
enum ItemE {Holztuer, Stahltuer, Ausstellungskasten, Kasse, Kasten, Schreibtisch, Nachtkaestchen, Wertschrank, Stahlschrank, Panzerschrank, Tresorraum,
 Mauer, Mauerecke, Steinmauer, Mauertor, Zaun, Zauntor, Saeule, Fenster, Alarmanlage_Z3, Alarmanlage_X3, Alarmanlage_Top, Mikrophon, Stechuhr, Scheinwerfer,
 Lichtschranke, Steuerkasten, Grab, Grabhuegel, Kreuz, Kranz, Gruft, Treppe, Sockel, WC, Sessel, Pult, Statue, Beutesack, Bett, Billardtisch, Sofa, Spiegel,
 Tisch, Kamin, Badewanne, Tresen, Gemaelde, Klavier, Buecherregal, Skelett, Dinosaurier, Elch, Kanone, Beefeater, Busch, Strauch, Gebuesch, Laubbaum,
 Nadelbaum, Hecke, Hantel, Regal, Flugzeugheck, linker_Flugzeugfluegel, rechter_Flugzeugfluegel, Bild, Vase, Kuehlschrank, Wache, Beichtstuhl, Kirchenbank,
 Altar, Kroehnungsstuhl, Opferkassa, Schrein, Kerzen, Weihwasserbecken, Heiligenstatue, Kerzenstaender, Kirchenkreuz, Gelaender, verzierte_Saeule,
 Regal_mit_Chemikalien, Versuchstisch, Kiste, Fasz, leere_Palette, Palette_mit_Schachteln, Absperrung, Hottentotten_Figur, Batman_Figur, Dicker_Man,
 Unbekannter, Jack_the_Ripper_Figur, Koenigs_Figur, Wache_Figur,
 Miss_World_1952, groszer_Koffer, Sitzbank, Speisetisch, Holzkiste, Palette_mit_Kisten, Postsack, Leiter, Zuggelaender, Lokomotive_vorne_rechts,
 Lokomotive_vorne_links, Lokomotive_oben, Lokomotive_seitlich, Lokomotive_Kabine, Lokomotive_Tuer};
...
enum JobE {Detektiv, Sprengmeister, Schlosser, Hehler, Haendler, Taxifahrer, Mechaniker, Elektriker, Sekretaerin, Anwalt, Unbekannt, Profiboxer,
 Angestellte, Soldat, Student, Literat, Professor, Hausfrau, Politiker, Abenteurer, Agent, Musiker, Pilot, Kellner, Rezeptionist, Polizeichef, Polizist,
 Moench, Inspektor, Pizzafahrer, Kellner_und_Student, Arbeiter, Butler, Krankenschwester};
enum LootE {Ein_Bild, Gold, Geld, Juwelen, Delikatessen, Eine_Statue, Eine_Kuriositaet, Ein_historisches_Kunstobjekt, Gebrauchsartikel, Eine_Vase};
