...
#define GFX_JAM_2 1 /* Hintergrund wird mit BackPen übermalt */
...
struct Collection
{
    ...
    void *p_ColorTable;  // stimmt nur eingeschränkt!!!! (nur solange der Buffer
                         // durch nichts anderes verändert wurde!
...
extern void gfxBlit(struct RastPort *srp, uword us_SourceX, uword us_SourceY, struct RastPort *drp, uword us_DestX,
...
extern void gfxMCGABlit(struct RastPort *srp, uword us_SourceX, uword us_SourceY, struct RastPort *drp, uword us_DestX,
                        uword us_DestY, uword us_Width, uword us_Height, uint32_t ul_BlitMode);
#endif
...
extern void gfxNCH4OLMCGAToNCH4Mask(void *sp, void *dp, uword x1, uword y1, uword x2, uword y2, uword w, uword h,
                                    uword sw, uword dw);
extern void gfxNCH4PutMCGAToNCH4Mask(void *sp, void *dp, uword x1, uword y1, uword x2, uword y2, uword w, uword h,
                                     uword sw, uword dw);
extern void gfxNCH4PutMCGAToNCH4(void *sp, void *dp, uword x1, uword y1, uword x2, uword y2, uword w, uword h, uword sw,
                                 uword dw);
extern void gfxNCH4OLMCGAToNCH4(void *sp, void *dp, uword x1, uword y1, uword x2, uword y2, uword w, uword h, uword sw,
                                uword dw);
extern void gfxNCH4OrMCGAToNCH4(void *sp, void *dp, uword x1, uword y1, uword x2, uword y2, uword w, uword h, uword sw,
                                uword dw);
extern void gfxNCH4AndMCGAToNCH4(void *sp, void *dp, uword x1, uword y1, uword x2, uword y2, uword w, uword h, uword sw,
                                 uword dw);
extern void gfxNCH4PutNCH4ToMCGA(void *sp, void *dp, uword x1, uword y1, uword x2, uword y2, uword w, uword h, uword sw,
                                 uword dw);
