...
#define INP_ALL_MODES                                                                                                 \
    (INP_UP | INP_DOWN | INP_LEFT | INP_RIGHT | INP_ESC | INP_LBUTTONP | INP_LBUTTONR | INP_RBUTTONP | INP_RBUTTONR | \
     INP_TIME | INP_MOUSE | INP_KEYBOARD | INP_SPACE)
